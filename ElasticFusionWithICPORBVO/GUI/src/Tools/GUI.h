...
class GUI
{
    public:
         ...
         : showcaseMode(showcaseMode)
        {
            ...
            useEASICPORB = new pangolin::Var<bool>("ui.Use ICPORB VO", false, true);
            useEASICPORBDA = new pangolin::Var<bool>("ui.Use Depth Alone", false, true);
            ...
            drawFxaa = new pangolin::Var<bool>("ui.Draw FXAA", true, true);
